import { Directive, EventEmitter, HostListener, Inject, Input, NgModule, Renderer, ViewContainerRef } from '@angular/core';
...
class SlimScrollDirective {
     ...
     * @param {?} document
     */
    constructor(viewContainer, renderer, document) {
